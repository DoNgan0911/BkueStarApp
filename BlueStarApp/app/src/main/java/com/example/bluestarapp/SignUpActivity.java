...
//            @Override
//            public void onClick(View view) {
//                String email, password,num_id, fullname;
//                num_id = numberid_et.getText().toString();
...
////                                                    int totalSize = queryDocumentSnapshots.size();
////                                                    DocumentReference userDocRef = db.collection("CUSTOMER").document(String.valueOf(totalSize+1));
////                                                    Map<String,Object> data = new HashMap<>();
////                                                    data.put("num_id", num_id);
////                                                    data.put("full_name", fullname);
////                                                    data.put("point",0);
////                                                    data.put("account_id", uid);
////                                                    db.collection("CUSTOMER").document("String.valueOf(totalSize+1)").set(data).addOnSuccessListener(new OnSuccessListener<Void>() {
////                                                        @Override
...
////                                                public void onFailure(@NonNull Exception e) {
////                                                    // Xử lý lỗi nếu có
////                                                    Log.e("SignUpActivity", "Authentication failed: " + e.getMessage());
////
////                                                }
////                                            });
//
