    ...
    public class FromLocation extends AppCompatActivity {
        ...
        private void initUI() {
            ...
            airportAdapter = new AirportAdapter(mListAirport, new IClickItemAirportListener() {
                ...
                public void onClickItemAirport(Airport airport) {
                    String Fromlocation = airport.getPlace().toString();
        ...
        private void onClickGoTo(Airport item) {
            ...
            returnIntent.putExtra("selectedAirport", AppUtil.FromLocation); // Ví dụ
